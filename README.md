...
## New Updates <a name="new_updates"></a>
...
8. B. G. Abreha, S. Agarwal, I. Foster, B. Blaiszik and S. A. Lopez, Virtual Excited State Reference for the Discovery of Electronic Materials Database: An Open-Access Resource for Ground and Excited State Properties of Organic Molecules, J. Phys. Chem. Lett., 2019, 10(21), 6835–6841 https://doi.org/10.1021/acs.jpclett.9b02577 (The VERDE Materials Database curates over 1500 π-conjugated organic molecules with ground- and excited-state geometries and photophysical properties: From  https://doi.org/10.1039/D5SC04079E)
